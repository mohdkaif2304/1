package com.example.android.newstodaytimes.Weather;

import static com.example.android.newstodaytimes.Weather.CityFinder.getCityNameUsingNetwork;
import static com.example.android.newstodaytimes.Weather.CityFinder.setLongitudeLatitude;
import static com.example.android.newstodaytimes.Weather.InternetConnectivity.isInternetConnected;
...
import com.example.android.newstodaytimes.databinding.ActivityWeatherBinding;
...
public class WeatherActivity extends AppCompatActivity {
    ...
    private void setUpDaysRecyclerView() {
        DayAdapter daysAdapter = new DayAdapter(this);
    ...
    private void checkUpdate() {
        AppUpdateManager appUpdateManager = AppUpdateManagerFactory.create(WeatherActivity.this);
        Task<AppUpdateInfo> appUpdateInfoTask = appUpdateManager.getAppUpdateInfo();
        appUpdateInfoTask.addOnSuccessListener(appUpdateInfo -> {
            if (appUpdateInfo.updateAvailability() == UpdateAvailability.UPDATE_AVAILABLE
                    && appUpdateInfo.isUpdateTypeAllowed(AppUpdateType.IMMEDIATE)) {
                try {
                    appUpdateManager.startUpdateFlowForResult(appUpdateInfo, AppUpdateType.IMMEDIATE, WeatherActivity.this, WEATHER_FORECAST_APP_UPDATE_REQ_CODE);
